...
CREATE TABLE `ohs_interface_config` (
  ...
  `request_template` varchar(255) DEFAULT NULL,
  `response_template` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `ohs_interface_config` VALUES ('4', '2019-07-18 21:14:43', 'admin', 'WEBSERVICE', 'POST', '61', '200', '2019-08-17 10:20:30', 'admin', '123', '123', '111111111', '<name>${name}</name>\n<age>${age}</age>', '<name>${name}</name>\n<age>${age}</age>');
INSERT INTO `ohs_interface_config` VALUES ('6', '2019-07-21 11:58:04', 'admin', 'RESETFUL', 'GET', '61', '200', null, null, '1231fdfdf', 'aasdf', '1dfasdfas', 'aaaaaaaaaaaaaaaaaaaaaaaa', 'aaaaaaaaaaaaaaaaaaaaa');
...
INSERT INTO `ohs_menu` VALUES ('15', '3', null, null, '2019-01-03 22:02:27', 'jiangjie', null, null, '1', '为系统下模块下添加要测试的系统接口', null, '接口配置', 'interfaceConfig', null, '0');
INSERT INTO `ohs_menu` VALUES ('16', '3', null, null, '2019-01-03 22:02:49', 'jiangjie', null, null, '1', '为接口新增测试案例', null, '案例配置', 'testsuitConfig', null, '0');
INSERT INTO `ohs_menu` VALUES ('19', '4', null, null, '2019-07-14 14:20:55', 'admin', null, null, '1', null, null, 'OHS', 'dataQuery', null, '0');
INSERT INTO `ohs_menu` VALUES ('20', '5', null, null, '2019-07-25 18:54:54', 'admin', null, null, '1', null, null, '接口测试', 'interfaceTest', null, '0');
INSERT INTO `ohs_menu` VALUES ('21', '5', null, null, '2019-07-25 18:55:49', 'admin', null, null, '1', null, null, '案例测试', 'testsuitTest', null, '0');
...
CREATE TABLE `ohs_testsuit_config` (
  ...
  `update_date` datetime DEFAULT NULL,
  `update_user` varchar(255) DEFAULT NULL,
  `after_oper_url` varchar(255) DEFAULT NULL,
  `after_req_opr_data` varchar(255) DEFAULT NULL,
  `after_rsp_data_regx` varchar(255) DEFAULT NULL,
  `pre_opr_url` varchar(255) DEFAULT NULL,
  `pre_req_opr_data` varchar(255) DEFAULT NULL,
  `pre_rsp_data_regx` varchar(255) DEFAULT NULL,
  `testsuit_name` varchar(255) DEFAULT NULL,
  `after_interface_id` int(11) DEFAULT NULL,
  `pre_interface_id` int(11) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `ohs_testsuit_config` VALUES ('5', '2019-07-20 09:39:46', 'admin', null, '61', null, null, '200', '2019-07-25 18:47:48', 'admin', null, '12321321', null, null, '123123', null, '开户查询', null, null, '1.0.0');

-- ----------------------------
-- Table structure for ohs_testsuit_records
-- ----------------------------
DROP TABLE IF EXISTS `ohs_testsuit_records`;
CREATE TABLE `ohs_testsuit_records` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `create_date` datetime DEFAULT NULL,
  `create_user` varchar(255) DEFAULT NULL,
  `interface_id` int(11) DEFAULT NULL,
  `request_data` varchar(255) DEFAULT NULL,
  `response_data` varchar(255) DEFAULT NULL,
  `testsuit_id` int(11) DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
  `update_user` varchar(255) DEFAULT NULL,
...
-- ----------------------------
-- Records of ohs_testsuit_records
-- ----------------------------
